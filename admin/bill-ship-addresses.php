...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Billing SubCounty  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Billing Ward <span>*</span></label>
...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Shipping SubCounty  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="shippingstate" name="shippingstate" value="<?php echo $row['shippingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Shipping Ward <span>*</span></label>
